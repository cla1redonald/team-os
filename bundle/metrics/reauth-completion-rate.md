...
**Current (illustrative).** 68% blended — a known weak spot. In-app prompts convert far better (81%) than email-only (44%). Sample: [synthetic-data](../../synthetic-data/reauth_events.csv).
