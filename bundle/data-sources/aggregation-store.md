...
**Key tables.** `connections`, `connection_attempts` (drives [CSR](/metrics/connection-success-rate.md)), `transactions_raw` (feeds [categorisation](/glossary/categorisation.md)). Illustrative extract: [synthetic-data/connection_attempts.csv](../../synthetic-data/connection_attempts.csv).
