...
| 35–42 | **The ask** | Participation | "It's all public. Help me make it better." — the repo tour (everything watched is in it), the call for challengers ("run it on one real corner of your team, break it, tell me where it's wrong"), and the take-home Yours exercise (interview-me prompt → first 3 concepts). No guided race: the live demo already showed the same thing. Overruns eat this block, never the argument. |
